          ...
          <div class="bg-primary-light rounded-lg shadow-lg px-5 py-8 sm:px-8 md:p-12">
            ...
            <x-dashboard.breadcrumb.main>
              ...
              <h1 class="page-header mt-8">
                ...
                Halaman Tambah Detail Kegiatan
              </h1>

              <div class="flex-row items-center">
                <div class="mt-4">
                  <form action="{{ route('detail.store', [$peralatan->id, $kegiatan->id]) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 grid-flow-row-dense gap-4">
                      ...
                      <div class="col-span-2">
                        ...
                        <x-dashboard.form.input name="nama_detail_kegiatan" type="text" id="nama-detail-kegiatan" value="{{ old('nama_detail_kegiatan') }}" autofocus/>
