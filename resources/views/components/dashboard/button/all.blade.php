<button
  type="submit"
  class="p-3 lg:p-3.5 text-base font-medium text-center inline-flex items-center text-base-light bg-secondary-light rounded-lg hover:bg-opacity-70 focus:z-10 focus:ring-2 focus:ring-secondary-light"
>
