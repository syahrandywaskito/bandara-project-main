<div class="inline-flex rounded-md shadow-lg ml-0 w-fit" role="group">
  <button
    type="submit"
    class="submitButton inline-flex items-center px-4 py-2 text-sm font-medium bg-secondary-light text-white rounded-l-lg hover:bg-indigo-500 focus:z-10 focus:ring-2 focus:ring-secondary-light"
    title="Submit data"
    >
  ...
  <button
    type="reset"
    class="inline-flex items-center px-4 py-2 text-sm font-medium bg-secondary-light text-white rounded-r-lg hover:bg-indigo-500 focus:z-10 focus:ring-2 focus:ring-secondary-light"
    title="reset form"
    >
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 md:mr-3 h-5">
      <path
